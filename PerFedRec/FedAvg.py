...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        if mean(hr_list) > best_hr_10 or mean(ndcg_list) > best_ndcg_10 or mean(hr_list_20) > best_hr_20 or mean(
        ...
        if epoch % 10 == 0:
            print(
                f"Best Result:{'%.4f' % best_hr_10},{'%.4f' % best_ndcg_10},{'%.4f' % best_hr_20},{'%.4f' % best_ndcg_20}")
